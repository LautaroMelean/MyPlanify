    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Admin'), ('moderator', 'Moderator'), ('business_owner', 'Business Owner'), ('event_organizer', 'Event Organizer'), ('user', 'User')], default='user', max_length=20)),
