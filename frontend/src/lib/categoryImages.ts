...
const CATEGORY_MAP: Array<[string[], string]> = [
  ...
  [['cine', 'cinema'],                              'photo-1585647347483-22b66260dfff'],
  ...
  [['deporte', 'fútbol', 'deportivo', 'estadio', 'club deportivo'], 'photo-1552674605-db6ffd4facb5'],
  [['gimnasia', 'trampolines', 'fitness'],          'photo-1552674605-db6ffd4facb5'],
